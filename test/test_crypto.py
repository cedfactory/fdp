...
class TestCrypto:
    ...
    def test_get_symbol_ohlcv(self):
        ...
        assert(ohlcv.iloc[0]["timestamp"] == 1646006400000)
        assert(ohlcv.iloc[0]["open"] == 33450.82)
        assert(ohlcv.iloc[0]["high"] == 38612.36)
        #assert(ohlcv.iloc[0]["low"] == 38344.53) # TODO to update
    ...
    def test_get_symbol_ohlcv_with_timestamp(self):
        ...
        assert(ohlcv.iloc[0]["open"] == 33450.82)
        assert(ohlcv.iloc[0]["high"] == 38612.36)
        #assert(ohlcv.iloc[0]["low"] == 38344.53000) # TODO to update
